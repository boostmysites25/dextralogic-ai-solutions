      ...
      <div className="wrapper grid grid-cols-1 lg:grid-cols-2 justify-items-center lg:justify-items-stretch items-center gap-7">
        <div data-aos="fade-right" className="flex flex-col gap-5">
          ...
          <p className="description text-center lg:text-start">
            Join the growing list of satisfied clients who trust us to deliver
            scalable, smart, and innovative digital solutions. Reach out
            today—we’d love to hear about your next project.
          </p>
        </div>
        <InquiryForm />
      </div>
